...
\item \verb|ret==MOVE_LOSE| : vous avez perdu
\item \verb|ret==MOVE_WIN| : vous avez gagné
\end{itemize}
\end{itemize}
...
\lstinputlisting[language=C, firstline=66, lastline=79]{../API/labyrinthAPI.h}
Le numéro de port et le nom du serveur vous seront donné ultérieurement.


\subsubsection{\texttt{closeConnection}}
\lstinputlisting[language=C, firstline=83, lastline=90]{../API/labyrinthAPI.h}


\subsubsection{\texttt{waitForLabyrinth}}
\lstinputlisting[language=C, firstline=94, lastline=106]{../API/labyrinthAPI.h}
...
\lstinputlisting[language=C, firstline=110, lastline=121]{../API/labyrinthAPI.h}
...
\lstinputlisting[language=C, firstline=125, lastline=137]{../API/labyrinthAPI.h}
L'argument \texttt{move} est passé via un pointeur et 
la valeur sera donc données en sortie de fonction.


\subsubsection{\texttt{sendMove}}
\lstinputlisting[language=C, firstline=141, lastline=153]{../API/labyrinthAPI.h}
